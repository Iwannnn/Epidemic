    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['illness:sequelae:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['illness:sequelae:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['illness:sequelae:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['illness:sequelae:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSequelae, getSequelae, delSequelae, addSequelae, updateSequelae } from "@/api/illness/sequelae";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSequelae(this.queryParams).then(response => {
        this.sequelaeList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.illnessSeqId != null) {
            ...
            addSequelae(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('illness/sequelae/export', {
        ...this.queryParams
      }, `sequelae_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
