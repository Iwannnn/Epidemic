<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="序号" prop="drugId">
        <el-input
    ...
    <el-table v-loading="loading" :data="drugList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药品特征" align="center" prop="appearance" />
      ...
      <el-table-column label="贮藏方法" align="center" prop="storageMethod" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="成分" prop="ingredient">
          <el-input v-model="form.ingredient" placeholder="请输入成分" />
        </el-form-item>
        <el-form-item label="药品特征" prop="appearance">
          <el-input v-model="form.appearance" placeholder="请输入药品特征" />
        </el-form-item>
        <el-form-item label="规格" prop="specification">
        ...
        <el-form-item label="不良反应" prop="adverseReaction">
          <el-input v-model="form.adverseReaction" placeholder="请输入不良反应" />
        </el-form-item>
        <el-form-item label="批准文号" prop="approvalNumber">
          <el-input v-model="form.approvalNumber" placeholder="请输入批准文号" />
        </el-form-item>
        <el-form-item label="贮藏方法" prop="storageMethod">
          <el-input v-model="form.storageMethod" placeholder="请输入贮藏方法" />
        </el-form-item>
        <el-form-item label="包装" prop="packaging">
          <el-input v-model="form.packaging" placeholder="请输入包装" />
        </el-form-item>
        <el-form-item label="有效期" prop="indata">
          <el-input v-model="form.indata" placeholder="请输入有效期" />
        </el-form-item>
        <el-form-item label="工厂" prop="factoryId">
...
<script>
import { listDrug, getDrug, delDrug, addDrug, updateDrug } from "@/api/illness/drug";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        appearance: [
          { required: true, message: "药品特征不能为空", trigger: "blur" }
        ],
        specification: [
        ...
        storageMethod: [
          { required: true, message: "贮藏方法不能为空", trigger: "blur" }
        ],
        packaging: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除药品管理编号为"' + drugIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('illness/drug/export', {
        ...this.queryParams
