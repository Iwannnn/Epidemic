    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['cases:history:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['cases:history:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listHistory, getHistory, delHistory, addHistory, updateHistory } from "@/api/cases/history";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('cases/history/export', {
        ...this.queryParams
